...
public class HistoricoOferta {
	...
	public HistoricoOferta(int hiof_codigo, int ofer_codigo,
			Date ofer_fechaRegistro, String ofer_empresa,
			Boolean ofer_esAgente, Boolean ofer_esCliente,
	...
	public void setHiof_codigo(int hiof_codigo) {
		this.hiof_codigo = hiof_codigo;
	}	
	public int getHiof_codigo() {
		return hiof_codigo;
	}
	...
	public void copiarValores(HistoricoOferta dAux){
		hiof_codigo = dAux.hiof_codigo;
	...
	public void copiarValoresOferta(Oferta oferta) {
		ofer_codigo=oferta.getOfer_codigo();
		ofer_fechaRegistro = oferta.getOfer_fechaRegistro() ;
		ofer_empresa = oferta.getOfer_empresa();
		ofer_esAgente = oferta.getOfer_esAgente();
		ofer_esCliente = oferta.getOfer_esCliente();
		ofer_esProspect = oferta.getOfer_esProspect();	
		ofer_pole = oferta.getOfer_pole();
		ofer_tipoEmpresa = oferta.getOfer_tipoEmpresa();
		ofer_usuario = oferta.getOfer_usuario();
		ofer_descripcionServicio = oferta.getOfer_descripcionServicio();
		ofer_fuente = oferta.getOfer_fuente();
		ofer_tipoOferta = oferta.getOfer_tipoOferta();
		ofer_fechaTope = oferta.getOfer_fechaTope();
		ofer_preparacionOferta = oferta.getOfer_preparacionOferta();
		ofer_maduracion = oferta.getOfer_maduracion();
		ofer_fechaUltimoEstado = oferta.getOfer_fechaUltimoEstado();
		ofer_motivoPerdida =oferta.getOfer_motivoPerdida();
		ofer_tlaTransporte = oferta.getOfer_tlaTransporte();
		ofer_tlaPvno = oferta.getOfer_tlaPvno();
		ofer_ovlGrupaje = oferta.getOfer_ovlGrupaje();
		ofer_ovlLtl = oferta.getOfer_ovlLtl();
		ofer_ovlFtl = oferta.getOfer_ovlFtl();	
		ofer_ovlXdock = oferta.getOfer_ovlXdock();
		ofer_ovlMaf = oferta.getOfer_ovlMaf();
		ofer_iliAlmacenaje = oferta.getOfer_iliAlmacenaje();
		ofer_iliTransporte = oferta.getOfer_iliTransporte();
		ofer_gsmTransporte = oferta.getOfer_gsmTransporte();
		ofer_ovsGrupaje = oferta.getOfer_ovsGrupaje();
		ofer_ovsLcl = oferta.getOfer_ovsLcl();
		ofer_ovsFcl = oferta.getOfer_ovsFcl();
		ofer_ovsFtl = oferta.getOfer_ovsFtl();
		ofer_ovsAereo = oferta.getOfer_ovsAereo();
		ofer_nacional = oferta.getOfer_nacional();
		ofer_internacional = oferta.getOfer_internacional();
		ofer_campanyaMarketing = oferta.getOfer_campanyaMarketing();
		ofer_gefcoSpecial = oferta.getOfer_gefcoSpecial();
		ofer_cotizadoOvl = oferta.getOfer_cotizadoOvl();
		ofer_cotizadoOvs = oferta.getOfer_cotizadoOvs();
		ofer_cotizadoIli = oferta.getOfer_cotizadoIli();
		ofer_cotizadoTla = oferta.getOfer_cotizadoTla();
		ofer_cotizadoGsm = oferta.getOfer_cotizadoGsm();
		ofer_conseguidoOvl = oferta.getOfer_conseguidoOvl();
		ofer_conseguidoOvs = oferta.getOfer_conseguidoOvs();
		ofer_conseguidoIli = oferta.getOfer_conseguidoIli();
		ofer_conseguidoTla = oferta.getOfer_conseguidoTla();
		ofer_conseguidoGsm = oferta.getOfer_conseguidoGsm();	
		ofer_renovadoOvl = oferta.getOfer_renovadoOvl();
		ofer_renovadoOvs = oferta.getOfer_renovadoOvs();
		ofer_renovadoIli = oferta.getOfer_renovadoIli();
		ofer_renovadoTla = oferta.getOfer_renovadoTla();
		ofer_renovadoGsm = oferta.getOfer_renovadoGsm();
		ofer_oportunidadTogether = oferta.getOfer_oportunidadTogether();
	}
}